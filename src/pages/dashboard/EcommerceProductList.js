...
import { ProductListHead, ProductListToolbar } from '../../components/_dashboard/e-commerce/product-list';
...
const TABLE_HEAD = [
  ...
  { id: 'brandId', label: 'BrandId', alignRight: true },
  { id: '' }
];
...
export default function EcommerceProductList() {
  ...
  return (
    <Page title="Ecommerce: Product List | R2S-UI">
              ...
              <Table>
                ...
                <TableBody>
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, description, rate, brandId } = row;
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            {/* <Avatar alt={displayname} src={displayname} /> */}
