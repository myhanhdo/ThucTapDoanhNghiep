...
const mockAPI = 'https://5fe0b53b04f0780017de93ac.mockapi.io/api/user';
// ----------------------------------------------------------------------
...
// Actions
export const { onToggleFollow, startLoading, createUserSuccess } = slice.actions;
...
export function getPosts() {
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.post('/identity/register');
